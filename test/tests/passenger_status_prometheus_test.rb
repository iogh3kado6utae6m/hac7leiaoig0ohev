...
describe "passenger status prometheus endpoint" do
  before do
  ...
  it "should handle empty or error responses gracefully" do
    response = Net::HTTP.get(URI("http://passenger_without_app:10254/monitus/passenger-status-prometheus"))
  ...
  it "should return content-type text/plain" do
    uri = URI("http://passenger_with_app:10254/monitus/passenger-status-prometheus")
